...
export default function NotFound() {
  ...
  return (
    <div className='min-h-screen w-full flex items-center justify-center px-4'>
      <div className='py-12 flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-24 items-center justify-center'>
        <Image
        ...
        <div className='flex flex-col items-center md:items-start justify-center text-center md:text-left'>
          ...
          <Link 
            ...
            className='px-6 py-3 bg-white hover:bg-gray-100 transition-colors rounded-full border border-black text-center'
          >
            Back to Home
          </Link>
        </div>
